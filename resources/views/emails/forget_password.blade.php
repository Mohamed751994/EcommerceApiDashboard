            ...
            <div class="col-md-8 mx-auto mt-5">
                <div class="row m-0 boxMail" style="background: white;padding: 45px; margin: 30px">
                    <div class="col-md-10 mx-auto" style="text-align: center;font-family: 'Roboto';font-weight: bold;direction: rtl;font-size: 18px;">
                        ...
                        <strong>
                            @lang('text.forgetPasswordHeader')
                        </strong>
                        <a href="{{$link}}" style="width:50%;margin: 30px auto;display: block; background: #f9ad29; padding: 20px;color: #fff; text-decoration: auto;font-weight: bold;"> @lang('text.reChangePassword')</a>
                        <p style=" font-size: 14px;color: #858585;">
                            @lang('text.forgetPasswordFooter')
                        </p>
